<div class="form-container" id="form-surat">
    @php
        ...
        $kandidats = App\Models\Warga::where('nomorKK', $kk->nomorKK)
            ...
            ->get();
    @endphp
    <form action="{{ route('home.store_surat', ['jenis' => 'surat-domisili']) }}" method="post">
        @csrf
        ...
        <div class="form-group">
            <label class="text-bold">Tujuan Permintaan Surat</label>
            <input type="text" name="tujuan" class="form-control">
            <small>*Gunakan kata <b>"untuk"</b> diawal kalimat. <br>e.g : "untuk pembuatan KJP"</small>
        </div>
