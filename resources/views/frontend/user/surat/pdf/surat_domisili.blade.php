...
<body>
    ...
    <div class="content">
        ...
        <p>
            Orang tersebut diatas, adalah benar-benar warga kami dan berdomisili di RT.123 RW.45 Desa Dummy Kecamatan
            Lorem Kabupaten Ipsum. Surat keterangan ini dibuat untuk {{ $surat->tujuan }}</p>
        <p>
